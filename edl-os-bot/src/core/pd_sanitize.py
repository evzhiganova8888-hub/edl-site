...
_PHONE_RE = re.compile(
    # [\s\-()]* (не ?) — ноль или более разделителей (пробел, дефис, скобки).
    # Нужно для формата «+7 (912) 345-67-89», где между кодом страны и кодом
    # региона два символа: пробел + открывающая скобка.
